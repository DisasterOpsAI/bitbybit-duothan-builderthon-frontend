      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-white/70">Platform performance and team insights</p>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-black/40 border-white/20 backdrop-blur-sm">
            ...
            <CardContent>
              ...
              <p className="text-xs text-white/60">All challenge attempts</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-black/40 border-white/20 backdrop-blur-sm">
            ...
            <CardContent>
              ...
              <p className="text-xs text-white/60">Platform average</p>
            </CardContent>
          </Card>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card className="bg-black/40 border-white/20 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription className="text-white/70">Submission statistics by challenge</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {analytics.challengeStats.map((challenge) => (
                  <div key={challenge.challengeId} className="p-4 bg-black/20 rounded-lg">
          ...
          <Card className="bg-black/40 border-white/20 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-white">Top Performing Teams</CardTitle>
              <CardDescription className="text-white/70">Leaderboard and performance metrics</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {analytics.teamPerformance.slice(0, 10).map((team) => (
                  <div key={team.teamId} className="flex items-center justify-between p-3 bg-black/20 rounded-lg">
                    ...
                    <div className="text-right">
                      <div className="text-white font-bold">{team.totalPoints} pts</div>
                      <div className="text-white/60 text-sm">{team.averageScore}% avg</div>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <Card className="bg-black/40 border-white/20 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-white">Programming Language Distribution</CardTitle>
            <CardDescription className="text-white/70">Most popular languages for algorithmic challenges</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {analytics.languageDistribution.map((lang) => (
                <div key={lang.language} className="p-4 bg-black/20 rounded-lg">
                  ...
                  <div className="text-white/60 text-sm mt-1">{lang.count} submissions</div>
                </div>
              ))}
            </div>
          </CardContent>
